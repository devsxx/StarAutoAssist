...
public class Communication extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img = findViewById(R.id.spimage);
        companyname = findViewById(R.id.companyname);
        contactno = findViewById(R.id.mobileno);
        address = findViewById(R.id.address);
        ratingBar = findViewById(R.id.ratingbar);
        recyclerView = findViewById(R.id.reviewlist);
        threebuttonlayout = findViewById(R.id.tributton);
        callbtn = findViewById(R.id.callbutton);
        chatbtn = findViewById(R.id.chatbutton);
        mapbtn = findViewById(R.id.mapbutton);
        acceptdeclinelayout = findViewById(R.id.acceptdeclinelay);
        acceptbtn = findViewById(R.id.accept_req_btn);
        declinebtn = findViewById(R.id.decline_req_btn);
