...
import com.app.starautoassist.Helper.Preview;
...
public class EditProfilePhoto extends AppCompatActivity implements View.OnClickListener {
    ...
    Camera camera;
    TextView  usephoto;
    ImageView cancelbtn, imageView, flashBtn, retake,take;
    ...
    protected void onResume() {
        ...
        Starautoassist_Application.registerReceiver(EditProfilePhoto.this);
    ...
    protected void onPause() {
        ...
        Starautoassist_Application.unregisterReceiver(EditProfilePhoto.this);
    }
